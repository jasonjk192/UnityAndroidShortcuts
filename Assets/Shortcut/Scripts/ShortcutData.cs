...
namespace WC.Shortcuts
{
    ...
    /// <para>For more information (short and long labels), check <see href="https://developer.android.com/develop/ui/views/launch/shortcuts/creating-shortcuts#attribute-values">attribute values</see></para>
    /// </summary>
    public struct ShortcutData
    {
        ...
        /// <summary>If a shortcut is made into it's own icon, then it uses the short label</summary>
        ...
        /// <para>Must be <b>'readable'</b> and <b>'uncompressed'</b> else no icon will be shown (shortcut will still be created)</para>
        /// <para>When in Editor, it will warn if the icon is invalid in console</para></summary>
